...
// function itself runs and returns output as an expression, not statement
(function () {
    let persons = [{
            name: 'Mostafa',
            age: 29,
...
// function assigned to a variable and returns output as an expression, not statement
...
// The same const 'person' here both inside and outside but it does not conflict with others because of local scope
console.log(person);