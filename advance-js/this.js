...
// You can use class instead but the same thing it is
// class Product {
//     constructor(productName, productPrice, productQuantity, productAvailability) {
//         this.productName = productName
//         this.productPrice = productPrice
//         this.productQuantity = productQuantity
//         this.productAvailability = productAvailability
...
// 4. 'this' indicates window object in not strict mode but undefined in strict mode (local scope)
...
sampleFunction(); // from window

student.s = sampleFunction;
student.s(); // from student object




// 5. 'this' indicates how we call the method (form inheritance)
...
const student1 = {
    sName: 'Shams',
    sId: 01,
    sCourse: 'JavaScript Programming',
    sDept: 'IIT'
}

// To solve this problem use .call() method
console.log(demoStudent.call(student1)); // Name - Shams, ID - 1, Course - JavaScript Programming, Department - IIT 
console.log(student.showStudentInfo()); // Name - Mostafa, ID - 3, Course - C Programming, Department - IIT


console.log(student1.showStudentInfo());
// But here shows 'student1.showStudentInfo is not a function'

// To solve this problem
student1.showStudentInfo = student.showStudentInfo;
console.log(student1.showStudentInfo());
// Name - Shams, ID - 1, Course - JavaScript Programming, Department - IIT 
